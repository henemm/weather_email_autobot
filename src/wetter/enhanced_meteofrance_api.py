        ...
        for entry in forecast_entries:
            try:
                ...
                if any(keyword in desc for keyword in thunderstorm_keywords):
                    # Map thunderstorm descriptions to severity levels
                    desc_lower = desc.lower()
                    if 'orages' in desc_lower and 'risque' not in desc_lower:
                        severity = 'high'
                    elif 'averses orageuses' in desc_lower:
                        severity = 'med'
                    elif 'risque d\'orages' in desc_lower or 'risque d’orages' in desc_lower:
                        severity = 'low'
                    else:
