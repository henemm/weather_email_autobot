#!/usr/bin/env python3
"""
FIX WIND AND GUST ALL POINTS
============================
Fix WIND and GUST debug output to show all n GEO points, not just those with data.
"""
...
# Find the WIND debug section and replace it
wind_old_section = '''            # Wind data debug (analog to Rain)
...
# Find the GUST debug section and replace it
gust_old_section = '''            # Gust data debug (analog to Rain)
...
print("   - Now shows ALL n GEO points (not just those with data)")
print("   - Analog to RAIN (mm) implementation")
print("   - Shows 0 values for points without data") 